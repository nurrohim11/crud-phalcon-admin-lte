...
<html>
    <head>
        ...
        {{ stylesheet_link('bower_components/morris.js/morris.css') }}
        {{ stylesheet_link('bower_components/jvectormap/jquery-jvectormap.css') }}
        {{ stylesheet_link('bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css') }}
        {{ stylesheet_link('bower_components/bootstrap-daterangepicker/daterangepicker.css') }}
   ...
   {{ javascript_include('bower_components/bootstrap/dist/js/bootstrap.min.js') }}
    <!-- Morris.js charts -->
   {{ javascript_include('bower_components/raphael/raphael.min.js') }}
  {{ javascript_include('bower_components/morris.js/morris.min.js') }}
    <!-- Sparkline -->
   {{ javascript_include('bower_components/jquery-sparkline/dist/jquery.sparkline.min.js') }}
    <!-- jvectormap -->
   ...
   {{ javascript_include('plugins/jvectormap/jquery-jvectormap-world-mill-en.js') }}
    <!-- jQuery Knob Chart -->
   {{ javascript_include('bower_components/jquery-knob/dist/jquery.knob.min.js') }}
    <!-- daterangepicker -->
   {{ javascript_include('bower_components/moment/min/moment.min.js') }}
   {{ javascript_include('bower_components/bootstrap-daterangepicker/daterangepicker.js') }}
    <!-- datepicker -->
   {{ javascript_include('bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js') }}
    <!-- Bootstrap WYSIHTML5 -->
   {{ javascript_include('plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js') }}
    <!-- Slimscroll -->
   {{ javascript_include('bower_components/jquery-slimscroll/jquery.slimscroll.min.js') }}
    <!-- FastClick -->
   {{ javascript_include('bower_components/fastclick/lib/fastclick.js') }}
    <!-- AdminLTE App -->
   {{ javascript_include('dist/js/adminlte.min.js') }}
    <!-- AdminLTE dashboard demo (This is only for demo purposes) -->
   {{ javascript_include('dist/js/pages/dashboard.js') }}
